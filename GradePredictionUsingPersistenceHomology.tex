...
%
\begin{keywords}
The evaluation of glandular structures in adenocarcinomas is a fundamental problem in digital pathology, with implications o
...
In clinical practice, histologic evaluation still largely involves the manual assessment of glass slides by a pathologist using a traditional microscope, although improvements in whole-slide imaging devices and subsequent regulatory approval of whole-slide-imaging and computational algorithms are rapidly paving the way for increased clinical use of digital pathology. Algorithmic evaluation of tissue specimens may eventually improve the efficiency, objectivity, reproducibility, and accuracy of the diagnostic process.
...
\begin{figure}[t]
\centering
\includegraphics[height=1.5in]{figures/train_22_gland_annot.png}
\includegraphics[height=1.5in]{figures/train_11_gland_annot.png}
\caption{Sample benign (a) and malignant (b) images overlaid with manually annotated glands.}
